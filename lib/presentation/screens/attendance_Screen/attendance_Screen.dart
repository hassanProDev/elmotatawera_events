                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextDeepBlue(
                      ...
                      textAlign: TextAlign.center,fontSize: SizeManager.size18,fontWeight: FontWeight.bold,
                    ),
                    TextDeepBlue(myCubit.invitationData!.guestData.firstName +
                        " " +
                        myCubit.invitationData!.guestData.lastName,fontSize: SizeManager.size14,fontWeight: FontWeight.bold,),
                    TextDeepBlue(myCubit.invitationData!.isConfirmed
                        ? "Confirmed"
                        : "Un Confirmed",fontSize: SizeManager.size14,fontWeight: FontWeight.bold,),
                    TextDeepBlue(myCubit.invitationData!.guestData.phone,fontSize: SizeManager.size14,fontWeight: FontWeight.bold,),
                    TextDeepBlue("Count : " +
                        myCubit.invitationData!.guestData.peopleCount.toString(),fontSize: SizeManager.size14,fontWeight: FontWeight.bold,),
                  ],
                ),
              ),
                  ...
                  !myCubit.invitationData!.guestData.attendance
                      ? CustomButton(
                          ...
                          onTap: () async {
                            ...
                            await myCubit.updateGuestData(myCubit.invitationData!);
                            myCubit
                                .addAttendance(AttendanceModel(
                                  attendanceData: AttendanceData(
                                      title: myCubit
                                          .invitationData!.guestData.titleEvent,
                                      firstName: myCubit
                                          .invitationData!.guestData.firstName,
                                      lastName: myCubit
                                          .invitationData!.guestData.lastName,
                                      uid: myCubit.invitationData!.uid,
                                      attendedWithId: myCubit.getUserData!.uid),
