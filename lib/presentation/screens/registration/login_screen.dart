                      ...
                      CustomButton(
                        ...
                        onTap: () async {
                          if (myCubit.loginFormKey.currentState!.validate()) {
                            await myCubit.userLogin(myCubit.loginEmail.text,
                                myCubit.loginPassword.text).then((v) {
                              myCubit.init();
                              myCubit.clearLoginController();
                              Navigator.pushReplacementNamed(context, myCubit.getUserData!.userData.userType);
                            });
                          }
                        },
                      ),
